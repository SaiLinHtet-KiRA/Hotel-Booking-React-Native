...
const PackageCollection_model_1 = require("./PackageCollection.model");
...
class GameService {
    ...
    async createGame(data) {
        try {
            ...
            const GameData = (0, validate_1.validateZod)(PackageCollection_model_1.GameSchema, gameData);
    ...
    async updateGame(id, data) {
        try {
            ...
            const GameData = (0, validate_1.validateZod)(PackageCollection_model_1.GameSchema, data);
