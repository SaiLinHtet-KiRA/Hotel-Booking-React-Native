...
exports.RatingSchema = zod_1.z.object({
    ...
    RatingsId: zod_1.z.any().refine((value) => mongoose_1.Types.ObjectId.isValid(value), {
        message: "Invalid ObjectId",
    }),
    rating: zod_1.z
...
const DSchema = new mongoose_1.Schema({
    ...
    RatingsId: { type: mongoose_1.Schema.Types.ObjectId, required: true },
    rating: { type: Number, required: true, min: 0, max: 5 },
    feed_back: { type: String, maxlength: 100 },
}, { versionKey: false, timestamps: true });
const RatingModel = mongoose_1.default.connection
    .useDb("Rating")
    .model("Rating", DSchema);
