...
const CheckAdminOrSelf_1 = __importDefault(require("./middleware/CheckAdminOrSelf"));
...
route.patch("/user/:id", CheckAdminOrSelf_1.default, User_controller_1.default.updateUser);
